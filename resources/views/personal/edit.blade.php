        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-10">
                <div class="text-center">
                    ...
                    <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">Edit Personal Information</h1>
                    <p class="text-blue-100 text-lg">Update your profile details and contact information</p>
                </div>
            </div>

            <!-- Form Section -->
            <div class="p-8">
                <form action="{{ route('personal.report.update', $personalInfo->id) }}" method="POST" class="space-y-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" 
                                       name="city" 
                                       value="{{ old('city', $personalInfo->city) }}" 
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" 
                                       name="street" 
                                       value="{{ old('street', $personalInfo->street) }}" 
                                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors bg-gray-50 focus:bg-white" 
                                       required>
                                @error('street')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" 
                                       name="building_name" 
                                       value="{{ old('building_name', $personalInfo->building_name) }}" 
                                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors bg-gray-50 focus:bg-white" 
                                       required>
                                @error('building_name')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" 
                                       name="floor_number" 
                                       value="{{ old('floor_number', $personalInfo->floor_number) }}" 
                                       class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors bg-gray-50 focus:bg-white">
                                @error('floor_number')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
