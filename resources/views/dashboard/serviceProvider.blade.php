        ...
        <div class="md:col-span-9 space-y-6">
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="border-b border-gray-200">
                    <div class="p-6">
                        <h2 class="text-xl font-semibold">Your Profile Info</h2>
                    </div>
                </div>
                <div class="p-6">
                    @if(session('success'))
                    ...
                    @if($provider && $provider->shop_name && $provider->location)
                        <!-- Show read-only info box if info exists -->
                        <div class="bg-gray-50 border border-gray-300 rounded p-6 space-y-3">
                            <p><strong>Shop Name:</strong> {{ $provider->shop_name }}</p>
                            <p><strong>Location:</strong> {{ $provider->location }}</p>
                            <p><strong>Description:</strong> {!! nl2br(e($provider->description)) ?: 'No description provided.' !!}</p>
                            <p><strong>Contact Info:</strong> {{ $provider->contact_info ?: 'No contact info provided.' }}</p>
                            ...
                            <div class="bg-gray-50 rounded-lg p-6 mb-4">
                                <div class="flex justify-between items-start">
                                    ...
                                    <div class="flex space-x-2">
                                        <a href="{{ route('services.edit', $service->id) }}" class="text-blue-600 hover:text-blue-900" title="Edit Service">
                                        ...
                                        <a href="{{ route('services.delete', $service->id) }}" 
                                           ...
                                           class="text-red-600 hover:text-red-900" title="Delete Service">
                                            <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="bg-white rounded-lg shadow">
    <div class="border-b border-gray-200">
        <div class="p-6 flex justify-between items-center">
            ...
            {{-- Add Product button always visible but disabled if no services --}}
            @if($services->isEmpty())
                <button disabled
                ...
                <div class="bg-gray-50 rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-4 flex justify-between items-center space-x-2">
                            <a href="{{ route('products.edit', $product->id) }}" class="text-blue-600 hover:text-blue-900" title="Edit Product">
                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
                            </a>
