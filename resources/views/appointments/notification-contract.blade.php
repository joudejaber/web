        ...
        <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-10">
                <div class="text-center">
                    ...
                    <p class="text-blue-100 text-lg">View contract information and work progress</p>
                </div>
            </div>
                ...
                <div class="space-y-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="w-full px-4 py-3 border border-gray-300 rounded-xl bg-gray-50">
                                    <span class="inline-flex px-3 py-1 rounded-full text-sm font-medium
                                        {{ strtolower($contract->status ?? '') === 'completed' ? 'bg-green-100 text-green-800' : 
                                           (strtolower($contract->status ?? '') === 'in_progress' ? 'bg-yellow-100 text-yellow-800' : 
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center space-x-3 mb-6">
                            ...
                            <h3 class="text-xl font-bold text-gray-900">Works Done</h3>
                        </div>
                        ...
                        @if($contract->works->isEmpty())
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-500 text-lg">No works recorded for this contract.</p>
                            </div>
                        @else
                            <div class="space-y-4">
