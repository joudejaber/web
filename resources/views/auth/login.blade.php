            ...
            <div class="glass-effect rounded-2xl p-8 shadow-2xl">
                <div class="text-center mb-8">
                    <h2 class="text-3xl font-bold tracking-tight text-gray-900 animate-fade-in-left" style="animation-delay: 0.4s;">
                        Welcome back to <span class="text-gradient">RenovAid</span>
                    </h2>
                    <p class="mt-2 text-sm text-gray-600 animate-fade-in-left" style="animation-delay: 0.5s;">
                        Sign in to continue your reconstruction journey
                    </p>
                </div>

                <form class="space-y-6 animate-fade-in-up" style="animation-delay: 0.6s;" action="{{ route('login.form') }}" method="POST">
                    @csrf
                    <div>
                ...
                <div class="mt-8 text-center animate-fade-in-up" style="animation-delay: 0.8s;">
                    <p class="text-sm text-gray-600">
                        Not a member?
                        <a href="{{ route('register') }}" class="font-semibold text-blue-600 hover:text-blue-500 transition-colors duration-300 group">
                            Register now
